...
saveRDS(summary_dtm_k13, pasteO(data_path, "summary_dtm_k13"))

summary_dtm_k13 <- readRDS(paste0(data_path, "summary_dtm_k13"))

summary_dtm_k13_tidied <- tidy(summary_dtm_k13)

saveRDS(pasteO(data_path, "summary_dtm_k13"))
